"""
Django settings for another_one project.
...
SECRET_KEY = 'django-insecure-zu4isc#$iwnbxnq+w3-_-itur!i2%(v)g)s0a2wq!1j^&b2hw%'
...
WSGI_APPLICATION = 'another_one.wsgi.application'
